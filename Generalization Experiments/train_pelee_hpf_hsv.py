# -*- coding: utf-8 -*-
"""
Created on Sun Jul 25 11:57:22 2021
...
train_imgs = ImageFolder(f"./Datafolder/Add/train(Add_8)(HSV)/",
                         transform=transforms.Compose([
                                 transforms.ToTensor()]
))
test_imgs = ImageFolder(f"./Datafolder/LSUN/HSV/test(sheep_PGGAN)(HSV)/",
                        transform=transforms.Compose([
                                transforms.ToTensor()]
))
...
def train_net(net, train_loader, test_loader,
    ...
    torch.save(net.state_dict(), f"./result/Add/epoch(Add_9(HSV)_pelee_hpf)_49.pth")

def Evaluate_Networks(Net):
    save_path = "./result/Add/"
    # data
    Net.load_state_dict(torch.load(save_path + "epoch(Add_10(HSV)_pelee_hpf)_49.pth"), strict=False)
